...
describe 'Login' do
    ...
    context 'Remetente' do
        it 'Sem tabela de frete' do
            fill_in 'mat-input-0', with: login #Usuário
            fill_in 'mat-input-1', with: senha #Senha
            click_button 'Entrar' #Btn Entrar da tela de Login
            sleep 2
            click_button 'Entrar' #Btn Entrar da tela Selecione Filial/Garagem
            fill_in("ex: 97898704021218987040212189870402198704021218", options = {:placeholder => 'ex: 97898704021218987040212189870402198704021218', :with => notafiscal}) #NF
            ...
            fill_in 'mat-input-74', with: quantidade #Quantidade
            fill_in 'mat-input-75', with: peso #Peso
            fill_in 'mat-input-76', with: valor #Valor da nota
            sleep 10
